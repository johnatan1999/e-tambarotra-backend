...
const SERVICE_FOLDER = path.join(
  process.cwd(),
  'src/modules/libs/%LIB_NAME%/src/core/services/inbounds/%SUB_FOLDER%',
);
...
const generateServiceInbound = (library_name, sub_folder, service_name) => {
  ...
  const newServicePath = `${path.join(realPath, service_name_lowercase)}.service.inbound.ts`;
