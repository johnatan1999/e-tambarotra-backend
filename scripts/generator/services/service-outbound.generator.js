...
const SERVICE_FOLDER = path.join(
  process.cwd(),
  'src/modules/libs/%LIB_NAME%/src/core/services/outbounds/%SUB_FOLDER%',
);
...
const generateServiceOutbound = (library_name, sub_folder, service_name) => {
  ...
  const newServicePath = `${path.join(realPath, service_name_lowercase)}.service.outbound.ts`;
